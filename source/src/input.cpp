...
//This function gets called the the beginning of each new frame
...
//This checks if a certain key was released during the current frame
bool Input::wasKeyReleased(SDL_Scancode key) {
	return this->_releasedKeys[key];
}

//This check if a certain key is held during the current frame
